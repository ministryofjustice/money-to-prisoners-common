'''
Include changes from https://github.com/unbit/uwsgi/commit/fe68884ea462126fedbfdb08fd33d7cdd55bf2a3
to fix python3 compatibility (not included in recent uwsgi releases for some reason)
'''
# flake8: noqa
